            ...
            <div className="rounded-xl shadow-xl bg-gray-800 border-box-500 ">
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={submit} className="space-y-3">
                        <input className="grid w-full grid-cols-[auto_1fr_auto] items-center gap-1 rounded-full px-4 py-2 text-left text-sm/6 text-gray-950/50 inset-ring inset-ring-gray-950/8 dark:bg-white/5 dark:text-white/50 dark:inset-ring-white/15" placeholder="Email" value={email}
