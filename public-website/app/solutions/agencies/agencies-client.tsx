                ...
                <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                The same plans as our main pricing page, tailored for agencies.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 flex flex-col">
                                ...
                                <Link 
                                    href={URL_AUTH_REGISTER} 
                                    className="block w-full px-6 py-3 bg-slate-100 text-slate-900 rounded-xl font-semibold hover:bg-slate-200 transition-colors text-center"
                                >
                                    Start Free Trial
                                </Link>
                            </div>

                            <div className="bg-white rounded-2xl border-4 border-purple-500 p-8 flex flex-col relative shadow-2xl">
                                ...
                                <ul className="space-y-4 mb-8 flex-grow">
                                    {[
                                        ...
                                        "AI heuristics with monthly limits",
                                        "White-label reports",
                                        "API access + Slack notifications"
                                    ].map((item, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                ...
                                <Link 
                                    href={URL_AUTH_REGISTER} 
                                    className="block w-full px-6 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 transition-colors text-center"
                                >
                                    Start Free Trial
                                </Link>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 flex flex-col">
                                ...
                                <ul className="space-y-4 mb-8 flex-grow">
                                    {[
                                        ...
                                        "AI heuristics with higher limits"
                                    ].map((item, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <HiCheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                                            <span className="text-slate-700">{item}</span>
                                ...
                                <Link 
                                    href={URL_AUTH_REGISTER} 
                                    className="block w-full px-6 py-3 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition-colors text-center"
                                >
                                    Start Free Trial
                                </Link>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border-2 border-slate-200 p-8 flex flex-col">
                                ...
                                <ul className="space-y-4 mb-8 flex-grow">
                                    {[
                                        ...
                                        "SSO, SAML, and on-prem options",
                                        "Dedicated account manager",
                                        "Custom integrations + SLAs",
                                        "Manual testing add-on"
                                    ].map((item, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <HiCheckCircle className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                                            <span className="text-slate-700">{item}</span>
