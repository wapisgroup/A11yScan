          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition-colors">
                ...
                <p className="text-sm text-indigo-200 mt-2">Powered by Axe-core engine</p>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Test with Chrome engine using Axe-core for accurate, real-world accessibility results.",
                ...
                },
                {
                  ...
                  description: "Every issue includes CSS selectors, WCAG criteria, severity levels, and fix recommendations.",
