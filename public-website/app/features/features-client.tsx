        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">
              Coverage from three engines
            </h2>
            <p className="text-lg text-slate-600">
              Combine deterministic rules, proprietary checks, and AI heuristics to catch more issues while keeping results transparent.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Deterministic rules</div>
              <h3 className="text-lg font-bold text-slate-900 mb-2">Axe-core</h3>
              <p className="text-slate-600 mb-4">Industry-standard automated WCAG checks with transparent rule logic.</p>
              <ul className="text-sm text-slate-600 space-y-2">
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Fast, repeatable coverage across pages</span>
                </li>
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Mapped to WCAG criteria in reports</span>
                </li>
              </ul>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Proprietary checks</div>
              <h3 className="text-lg font-bold text-slate-900 mb-2">Ablelytics-core</h3>
              <p className="text-slate-600 mb-4">Deterministic checks built for real-world UI patterns and workflows.</p>
              <ul className="text-sm text-slate-600 space-y-2">
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Finds issues in navigation, focus, and structure</span>
                </li>
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Provides selectors, context, and evidence</span>
                </li>
              </ul>
            </div>
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">AI heuristics</div>
              <h3 className="text-lg font-bold text-slate-900 mb-2">Ablelytics-AI</h3>
              <p className="text-slate-600 mb-4">AI-assisted analysis for content intent and hard-to-automate checks.</p>
              <ul className="text-sm text-slate-600 space-y-2">
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Surfaces gaps like unclear labels or missing context</span>
                </li>
                <li className="flex items-start gap-2">
                  <HiCheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                  <span>Returns confidence, evidence, and fix ideas</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-600 mb-4">
                  Advanced algorithms detect color contrast, heading structure, ARIA issues, and AI-assisted heuristics
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 text-sm text-slate-600">
                    <HiCheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2 text-sm text-slate-600">
                    <HiCheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>AI fix suggestions and evidence</span>
                  </li>
                </ul>
              </div>
