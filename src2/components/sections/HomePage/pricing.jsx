    ...
    return (
        <section id="pricing" className="grid grid-cols-1 md:grid-cols-3 gap-small">
            <WhiteBox extraClass="gap-medium justify-between p-[20px]">
                ...
                <div>
                    <Button type="primary" onClick={startTrial} title={`Start free`} />
                </div>
            </WhiteBox>
            ...
            <WhiteBox extraClass="gap-medium justify-between p-[20px]">
                ...
                <div>
                    <Button type="primary" onClick={contactSales} title={`Get Team`} />
                </div>
            </WhiteBox>
            ...
            <WhiteBox extraClass="gap-medium justify-between p-[20px]">
                ...
                <div>
                    <Button type="primary" onClick={contactSales} title={`Contact Sales`} />
                </div>
            </WhiteBox >
        </section >
    )
