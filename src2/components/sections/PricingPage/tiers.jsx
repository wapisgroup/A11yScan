            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <WhiteBox largeRounded extraClass="justify-between gap-medium">
                    ...
                    <div className="text-center">
                        <Button className="w-[100%] justify-center" type="secondary" title={`Start free`} href={startTrial} />
                    </div>
                </WhiteBox>
                ...
                <WhiteBox largeRounded extraClass="justify-between gap-medium">
                    ...
                    <div className="text-center">
                        <Button className="w-[100%] justify-center" type="primary" title={`Get Team`} href={startTrial} />
                    </div>
                </WhiteBox>
                ...
                <WhiteBox largeRounded extraClass="justify-between gap-medium">
                    ...
                    <div className="text-center">
                        <Button className="w-[100%] justify-center" type="secondary" title={`Contact Sales`} href={startTrial} />
                    </div>
                </WhiteBox>
