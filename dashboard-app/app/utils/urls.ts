...
export const URL_APP_PROFILE = `${URL_APP_WORKSPACE}/profile/`
export const URL_APP_ORGANISATION = `${URL_APP_WORKSPACE}/organisation/`
export const URL_APP_BILLING = `${URL_APP_WORKSPACE}/billing/`
export const URL_APP_DASHBOARD = `${URL_APP_WORKSPACE}/`
